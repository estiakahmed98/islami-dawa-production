...
//   const sendApprovalEmail = async (email: string, name: string, leaveType: string, leaveDates: string) => {
//     try {
...
const AdminNotifications: React.FC = () => {
  ...
  const sendRejectionEmail = async (email: string, name: string, leaveType: string, leaveDates: string, reason: string) => {
    try {
