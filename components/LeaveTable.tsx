...
//   id?: string;
//   leaveType: string;
//   from: string; // ISO date string for UI
//   to: string;   // ISO date string for UI
//   days: number;
//   reason: string;
//   approvedBy: string;
...
//     const dd = new Date(d);
//     // keep original time if needed for PDF; for table we’ll show local date/time as-is
...
//     const v = (s || "").toLowerCase();
//     if (v === "approved") return "bg-green-500 text-white";
//     if (v === "rejected") return "bg-red-800 text-white";
...
//       // API returns: { leaveRequests: Array<LeaveRequest> }
...
//       // optional: newest first by requestDate/createdAt if provided
...
//       headers.forEach((h) => {
//         (h as HTMLElement).style.backgroundColor = "#2d3748";
...
//     container.appendChild(table as Node);
...
//     let statusStyle = "";
//     if (v === "pending") statusStyle = "background-color: #fed7d7; color: #9b2c2c;";
//     else if (v === "approved") statusStyle = "background-color: #10b981; color: white;";
//     else if (v === "rejected") statusStyle = "background-color: #7f1d1d; color: white;";
...
//                   <TableCell>{new Date(leave.from).toLocaleString()}</TableCell>
//                   <TableCell>{new Date(leave.to).toLocaleString()}</TableCell>
//                   <TableCell>{leave.days}</TableCell>
//                   <TableCell>{leave.phone || "N/A"}</TableCell>
//                   <TableCell>{leave.reason}</TableCell>
//                   <TableCell>
//                     <span
//                       className={`px-2 py-1 rounded-md text-sm flex items-center justify-center font-semibold ${statusClass(
//                         leave.status
//                       )}`}
//                     >
//                       {leave.status}
...
//                         <Button variant="ghost" onClick={() => handleEdit(leave)}>
//                           Edit
//                         </Button>
//                       ) : (
//                         <Button
